...
#visibility words
alg = pickle.load(open(algo_dir+"llmvis_"+oaci+"_d0.al","rb"))
model_x_var = df_all[alg["x_var"]]
df_all["vis_ml"] =  alg["pipe"].predict(model_x_var)


#wx words
alg = pickle.load(open(algo_dir+"llmwx_"+oaci+"_d0.al","rb"))
model_x_var = df_all[alg["x_var"]]
df_all["wx_ml"] =  alg["pipe"].predict(model_x_var)

#cfl words
#df_all['cfl0_l'] = round(df_all["cfl0"],1).apply(transform_value_l)
alg = pickle.load(open(algo_dir+"llmskyc1_"+oaci+"_d0.al","rb"))
model_x_var = df_all[alg["x_var"]]
df_all["cfl_ml"] =  alg["pipe"].predict(model_x_var)

#clouds height
alg = pickle.load(open(algo_dir+"llmskyl1_"+oaci+"_d0.al","rb"))
model_x_var = df_all[alg["x_var"]]
...
alg = pickle.load(open(algo_dir+"llmskyc2_"+oaci+"_d0.al","rb"))
model_x_var = df_all[alg["x_var"]]
...
#temp dew words
alg = pickle.load(open(algo_dir+"llmtempd_"+oaci+"_d0.al","rb"))
model_x_var = df_all[alg["x_var"]]
...
#load model
#model = load_model("/content/drive/MyDrive/Colab Notebooks/gpt/i+d/model_ml.keras")
model = load_model(algo_dir+oaci+"ml.keras")

# Load the JSON configuration from the file
#with open("/content/drive/MyDrive/Colab Notebooks/gpt/i+d/tokenizerml.json", 'r', encoding='utf-8') as f:
   # tokenizer_json = json.load(f)
with open(algo_dir+oaci+"ml.json", 'r', encoding='utf-8') as f:
   tokenizer_json = json.load(f)
